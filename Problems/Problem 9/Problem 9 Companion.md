...
# Companion — Search Types & Indexing

**Domain:** Database Design & Query Optimization  
**Topics:** search types · indexing · full-text

**Pairs with:** [[Our DB queries are searching wrong]] · [[Problems MOC]]
...
- Scenario: [[Our DB queries are searching wrong]]
